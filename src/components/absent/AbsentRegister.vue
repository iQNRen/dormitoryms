...
<script>
import {
  findDormitoryByBuildingId,
  findStudentByDormitoryId,
  absentSave,
  buildingList,
} from "../../api/absent";
...
export default {
  ...
  methods: {
    buildingChange() {
      const _this = this;
      findDormitoryByBuildingId(_this.ruleForm.buildingId).then(function (
        resp
      ) {
    ...
    dormitoryChange() {
      const _this = this;
      findStudentByDormitoryId(_this.ruleForm.dormitoryId).then(function (
        resp
      ) {
  ...
  created() {
    const _this = this;
    buildingList().then(function (resp) {
      _this.buildingList = resp.data;
    });
  },
};
</script>
